...
import { FaChartPie, FaBox, FaUsers, FaSignOutAlt, FaShieldAlt, FaUserCircle } from 'react-icons/fa';
        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-[#0F111A]">
            ...
            <aside className="w-full lg:w-80 bg-[#141621] border-r border-gray-800 flex flex-col lg:sticky lg:top-0 h-auto lg:h-screen overflow-y-auto z-40">
                ...
                <div className="p-8 border-b border-gray-800/50 bg-gradient-to-b from-gray-800/5 to-transparent">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-yellow-500/10 text-yellow-500 rounded-2xl flex items-center justify-center border border-yellow-500/20 font-black">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[8px] font-black text-gray-500 uppercase tracking-widest">Active System Manager</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <nav className="flex-1 p-6 space-y-2">
                    ...
                    <NavLink to="/admin" end className={({ isActive }) => isActive ? activeClass : inactiveClass}>
                        <FaChartPie className={`${activeClass ? '' : 'text-gray-500 group-hover:text-yellow-500'}`} />
                        Overview Summary
                    </NavLink>
                    <NavLink to="/admin/products" className={({ isActive }) => isActive ? activeClass : inactiveClass}>
                        <FaBox className={`${activeClass ? '' : 'text-gray-500 group-hover:text-yellow-500'}`} />
                        Storage & Inventory
                    </NavLink>
                    <NavLink to="/admin/users" className={({ isActive }) => isActive ? activeClass : inactiveClass}>
                        <FaUsers className={`${activeClass ? '' : 'text-gray-500 group-hover:text-yellow-500'}`} />
                        Account Governance
                    </NavLink>
                </nav>
                ...
                <div className="p-6 mt-auto border-t border-gray-800/50">
                    ...
                    <div className="mt-4 flex items-center justify-center gap-2 opacity-30">
                        <FaShieldAlt className="text-gray-500 text-[8px]" />
                        <span className="text-[8px] font-bold text-gray-600 uppercase tracking-widest">Secure Admin Access Only</span>
                    </div>
                </div>
            </aside>
            ...
            <main className="flex-1 p-8 lg:p-12 relative overflow-y-auto">
                <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
                    ...
                    <div className="bg-[#1A1C29]/50 border border-gray-800 rounded-[40px] p-10 shadow-2xl relative overflow-hidden backdrop-blur-sm min-h-[80vh]">
